...
export const FeatureSection = () => {
	return (
		<section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:pt-16 md:py-10">
			<div className="flex flex-col p-6 gap-4 rounded-lg bg-gray-500 md:p-12">
			...
			<div className="col-span-full flex flex-col gap-4">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500">
					<div className="flex flex-col gap-2">
						...
						<h2 className="font-sans text-gray-100 text-heading-lg">
							Tenha uma loja online com a cara da sua marca
						</h2>
