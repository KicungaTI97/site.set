				...
				<div className="grid gap-6 md:grid-cols-3">
					...
					<div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
						...
						<p className="text-body-sm text-gray-200">
							Adicione sua logo, favicon, cores do seu catalogo e tenha tudo com
							a sua cara.
						</p>
					</div>
					...
					<div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
						...
						<p className="text-body-sm text-gray-200">
							Não importa a loja, o site.set permite que você insere qualquer
							link de afliiado.
						</p>
					</div>
					...
					<div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
						...
						<p className="text-body-sm text-gray-200">
							Nossa equipe está sempre pronta para te atender, para te ajudar no
							que for preciso.
						</p>
					</div>
				</div>
